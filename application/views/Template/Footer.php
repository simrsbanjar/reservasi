...
<script>
    $(document).ready(function() {
        ...
        if (page == null) {
            ...
            html += '<li class="active"><a href="CariReservasi"><i class="fas fa-clipboard-list"></i> Daftar</a></li>';
            $('#myList').html(html);
        } else {
            $("#daftar").hide();
            var html = '';
            html += '<li><a href="Home"><i class="fas fa-home"></i> Home</a></li>';
            html += '<li class="active"><a href="Reservasi"><i class="fas fa-search"></i> Cari</a></li>';
