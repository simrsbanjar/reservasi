    ...
    function E(p, v) {
                ...
                i
                    ? ((o.tabIndex = -1),
                      ve(t) &&
                          ...
                          "range" === w.config.mode &&
                              (d(o, "startRange", w.selectedDates[0] && 0 === M(t, w.selectedDates[0], !0)), d(o, "endRange", w.selectedDates[1] && 0 === M(t, w.selectedDates[1], !0)), "nextMonthDay" === e && o.classList.add("inRange"))))
        ...
        function G(e, t) {
            ...
            (n < 0 && !0 === w._hidePrevMonthArrow) ||
                ...
                ((w.currentMonth += n),
                (w.currentMonth < 0 || w.currentMonth > 11) && ((w.currentYear += w.currentMonth > 11 ? 1 : -1), (w.currentMonth = (w.currentMonth + 12) % 12), pe("onYearChange"), K()),
                J(),
                pe("onMonthChange"),
                De());
        }
        ...
        function Z(e) {
            if (w.isOpen && !w.config.inline) {
                ...
                i &&
                    o &&
                    (void 0 !== w.timeContainer && void 0 !== w.minuteElement && void 0 !== w.hourElement && "" !== w.input.value && void 0 !== w.input.value && I(),
                    w.close(),
            ...
            return function (t) {
                ...
                void 0 !== n && (w["min" === e ? "minDateHasTime" : "maxDateHasTime"] = n.getHours() > 0 || n.getMinutes() > 0 || n.getSeconds() > 0),
                    w.selectedDates &&
                        ...
                        be()),
                    w.daysContainer &&
                        (de(), void 0 !== n ? (w.currentYearElement[e] = n.getFullYear().toString()) : w.currentYearElement.removeAttribute(e), (w.currentYearElement.disabled = !!a && void 0 !== n && a.getFullYear() === n.getFullYear()));
            };
        }
        function re() {
